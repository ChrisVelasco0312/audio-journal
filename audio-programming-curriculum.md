...
- **MAIN MATERIAL** — the resource(s) you actually work through to learn the topic. This is your "course." If it is a book and no free online course covers the same ground, the book _is_ your course and is marked as such.
...
| **BOOK (MAIN)**      | A book _replaces_ a free course — there is no open course that covers the same material, so you treat the book as your main course. Pay the ~$30–$80 once; it pays off for years. |
...
_"You can't build a house on sand."_
...
| **3Blue1Brown — "Essence of Linear Algebra" + "Essence of Calculus"**                               | VIDEO (FREE)  | Free     | <https://www.youtube.com/@3blue1brown/playlists> | Beautiful visual explanations. Watch the linear-algebra and calculus journeys _once,_ even if you also use Khan Academy. |

**Specific math topics you need (in rough order):**

1. **Arithmetic and Basic Algebra** — variables, equations, functions, graphs
2. **Trigonometry** — sine, cosine, tangent, unit circle, radians, phase. _Critical for audio._
3. **Complex Numbers** — imaginary unit, complex plane, Euler's formula (e^(jθ) = cos(θ) + j·sin(θ)). _Essential for DSP._
4. **Logarithms and Decibels** — log base 10, decibel scale, how humans perceive loudness and frequency. _Used everywhere in audio._
5. **Calculus (introductory)** — derivatives, integrals, limits, basic differential equations. _You need this for understanding filters and continuous signals._
6. **Linear Algebra (basics)** — vectors, matrices, matrix multiplication. _Used in advanced DSP, machine learning for audio._
7. **Probability & Statistics (basics)** — random variables, mean, variance, probability distributions. _Useful for noise generation, stochastic processes._

#### BIBLIOGRAPHY REFERENCES

| Resource                                                                                                         | Tag        | Cost                            | Link                                                                                                                                                   | Notes                                                                                                                  |
| ---------------------------------------------------------------------------------------------------------------- | ---------- | ------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------- |
| **An Introduction to the Mathematics of Digital Signal Processing** by F.R. Moore (Computer Music Journal, 1978) | BOOK (BIB) | Paywall (often findable as PDF) | PART I: <https://www.jstor.org/stable/3680137/> PART II: <https://www.jstor.org/stable/3680221/>                                                       | Two-part article, audio-targeted math. Read it for the bridge between math and DSP; not required to complete the path. |
...
> **Key insight from Matthijs Hollemans (audiodev.blog):** _"Don't go and study math on its own, do it in the context of digital signal processing. Get a couple of DSP books first, and if you get stuck, level up the areas of math you're having problems with."_
...
_If you already know how to program, skip to 0.2b._
...
_Once you have basic programming knowledge, jump into C++. If your goal is audio software, go straight to C++ — don't waste time learning "simpler" languages first._
...
> **Important:** Learn C++ and audio programming _together_. Studying C++ in isolation is not productive. Start writing simple audio code as soon as you know the basics.
...
_You can't write audio software if you don't understand what audio professionals do with it. This is called "domain knowledge."_
...
> This is where the future audio programmer experiences synthesis _as a user_ before reimplementing it as a developer. Everything here is 100% free; the one paid item (Syntorial) is kept as an optional encore because its free demo already covers a substantial chunk of subtractive synthesis by ear.

##### MAIN MATERIAL

Work through these in roughly the order shown — start with an interactive playground, add a video ear-training series, then go deep on a real instrument.

| Resource                                                                  | Tag              | Cost | Link                                                                                                                            | Notes                                                                                                                                                                                                                                                                                                                  |
| ------------------------------------------------------------------------- | ---------------- | ---- | ------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Ableton — Learning Synths**                                             | COURSE (FREE)    | Free | <https://learningsynths.ableton.com>                                                                                            | **Start here.** Interactive in-browser synth playground. Walks you from "what is a waveform?" through oscillators, envelopes, LFOs, filters, FM. You build patches right on the page. The single most accessible free on-ramp to sound design. Companion lessons ship with the "Playground" chapter to experiment in. |
| **Ableton — Learning Music**                                              | COURSE (FREE)    | Free | <https://learningmusic.ableton.com>                                                                                              | Sibling site to _Learning Synths_. Covers beats, notes, scales, chords, basslines, melodies, song structure — all interactive in the browser. Gives you the musical grammar that makes synth patches "speak." Skim it before/while doing _Learning Synths_ if your music theory from 0.4b is still shaky.        |
| **Syntorial — Free Demo** (Audible Genius)                                | Software (FREE)  | Free | <https://www.syntorial.com/try-for-free>                                                                                        | 22 of the full 199 lessons — no time limit, no credit card. Teaches subtractive synthesis **by ear, video-game style**: hide-and-match sound design against the built-in "Primer" synth. Trains the exact skill audio programmers need later — recognising what a filter, envelope, or LFO is doing to a signal.        |
| **Sound On Sound — "Synth Secrets" (Gordon Reid)**                         | REFERENCE (FREE) | Free | Series index: <https://www.soundonsound.com/series/synth-secrets>                                                              | The canonical 63-part synthesis course disguised as magazine articles. Starts at waveforms and harmonics, builds up through subtractive, additive, FM, ring mod, waveshaping, physical modeling, etc. Referenced again at 0.3a — re-listed here because this is where you actually _read_ it. The closest free equivalent to a university synthesis textbook. |
| **Andrew Huang — synthesis videos**                                        | VIDEO (FREE)     | Free | <https://www.youtube.com/@andrewhuang> (search channel for "synthesis", "FM", "subtractive")                                    | Friendly, fast, modern introductions to synthesis concepts and patching techniques. Good visual companion once you've finished _Learning Synths_.                                                                                                                                                                    |
| **Marc Doty / AutomaticGainsay — "Know Your Synthesizer" & tutorials**    | VIDEO (FREE)     | Free | <https://www.youtube.com/@AutomaticGainsay>                                                                                     | The most pedagogically rigorous free synthesis channel on YouTube. Marc is a synth historian who walks through classic analogue designs oscillator-by-oscillator, envelope-by-envelope, and explains _why_ each module sounds the way it does. Essential deep-dive partner to the SoS _Synth Secrets_ articles.       |
| **VCV Rack 2 (free edition) + Omri Cohen tutorials**                       | Software (FREE)  | Free | VCV Rack: <https://vcvrack.com> · Omri Cohen (best free VCV tutorial channel): <https://www.youtube.com/@OmriCohen>            | Free open-source Eurorack simulator, runs on Win/macOS/Linux. Best way to learn modular sound design and signal flow without spending a cent. Omri Cohen's YouTube channel is the de-facto free "course" for the platform — go through his beginner playlist and rebuild every patch he demonstrates.             |
| **Vital (free wavetable synth) + official tutorial videos**               | Software (FREE)  | Free | Vital: <https://vital.audio> · tutorials: <https://vital.audio/help/> (and search "Vital synth tutorial" on YouTube)            | The most powerful free wavetable synth on the market — direct competitor to Xfer Serum ($189). Use it to learn wavetable synthesis, modulation matrix design, and visualising spectral content. The free tier is functionally identical to the paid tiers for learning purposes.                                        |

##### BIBLIOGRAPHY REFERENCES

| Resource                                                       | Tag               | Cost                 | Link                                                                                     | Notes                                                                                                                                                                                                              |
| -------------------------------------------------------------- | ----------------- | -------------------- | ---------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Syntorial — full version** (Audible Genius)                  | Software/training | ~$130 (demo is free) | <https://www.syntorial.com>                                                              | The full 199-lesson program covers subtractive, FM, wavetable, and several synth-specific lesson packs (Serum, Pigments, etc.). Only buy if you finished the free 22-lesson demo and want ear-training at scale. The demo is enough to start. |
| **SoundGym — Sound Design / Frequency ear training (free tier)** | Software (FREE)  | Free tier            | <https://www.soundgym.co>                                                                 | Browser-based "gym" for audio ear training: identify frequency bands, compression amounts, reverb tails. Free tier offers a daily workout; helpful for training the exact listening skills synthesis-by-ear requires. |
| **Mr Bill TV / Multiplier / In The Mix — sound design videos** | VIDEO (FREE)      | Free                 | Mr Bill: <https://www.youtube.com/@mrbillstunes> · Multiplier: <https://www.youtube.com/@Multipliar> · In The Mix: <https://www.youtube.com/@InTheMix> | Widely recommended YouTube instructors for modern sound-design workflow in DAWs. Less synthesiser theory, more "how do you design bass / pads / drums / FX for tracks". Useful once you understand synthesis basics.   |
| **Reverb.com — "Sound Design" & "Synth Tutorials" video series** | VIDEO (FREE)     | Free                 | <https://www.reverb.com/news> (search "synth tutorial", "sound design")                  | Hands-on gear walkthroughs and patches. Nice for tying synthesis concepts back to real hardware instruments.                                                                                                       |
| **freesound.org**                                              | REFERENCE (FREE)  | Free                 | <https://freesound.org>                                                                  | The largest free CC-licensed sample archive. Use it for sampling exercises and as a source of raw material for your own sound-design practice. (Referenced again in Level 2 for MIR purposes.)                    |

**What to learn:** Subtractive synthesis, FM synthesis, additive synthesis, wavetable synthesis, sampling, granular/playback concepts, envelopes (ADSR), filters (low-pass, high-pass, band-pass, notch), LFOs and modulation matrices, modulation routing, signal flow in a synthesiser voice (oscillator → mixer → filter → amplifier → effects), patching on a modular system. The goal is to internalise these concepts from a _user_ perspective — being able to **hear a sound and describe how it was made** — _before_ you implement them as a programmer in Levels 3–4.

---

## LEVEL 1: DIGITAL SIGNAL PROCESSING (DSP) FUNDAMENTALS

_"DSP is the heart of audio programming."_
...
_"Now we apply DSP to the domain of sound and music."_
...
_"Now we build real audio software."_
...
**Why these first and not Pirkle?** Hollemans' books explain _everything_ from scratch, including the C++ and JUCE setup. Pirkle's books assume you already know C++ and jump straight into DSP algorithms. Hollemans is the bridge.
...
_"Create new sounds from mathematics."_
...
- **Months 2-3**: C++ basics (C++ Primer **[BOOK MAIN]** _or_ The Cherno videos **[FREE]**) + Physics of sound (MIT OCW 8.03 **[FREE]**)
...
- **Month 10**: Read Hollemans' _Beginner's Plugin Book_ (**[BOOK MAIN]**) while following along in code

### Phase 4: Plugin Development (Months 11-16)

- **Month 11**: Official JUCE Course **[FREE]** — build the tremolo plugin
- **Months 12-13**: Hollemans' _Synth Plugin Book_ **[BOOK MAIN]** — build a complete synthesizer
- **Months 14-16**: Pirkle's _Synth Book_ + Pirkle's _Effects Book_ **[BOOK MAIN]** — build multiple synthesizer and effect plugins
...
_Curated from research across university curricula, industry recommendations, and community wisdom._
