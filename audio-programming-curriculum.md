...
**What to learn:** Subtractive synthesis, FM synthesis, sampling, envelope (ADSR), filters (low-pass, high-pass, band-pass), LFOs, modulation. Understanding these concepts from a _user_ perspective before implementing them as a programmer.
